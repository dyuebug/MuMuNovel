...
# NOTE: keep execute_chapter_analysis_background patchable in tests; avoid
# binding it at import time from manual_chapter_analysis_execution_service.
...
async def trigger_chapter_analysis_with_default_route_wiring(
    *,
    ...
    background_tasks.add_task(
        __import__(
            "app.services.chapter_analysis_task_route_compat_service",

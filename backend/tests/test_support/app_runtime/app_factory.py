...
from tests.test_support.retired_runtime_test_support import get_logger, setup_logging

from tests.test_support.app_runtime.lifespan import (
    create_lifespan,
    recover_startup_status_if_possible,
)
from tests.test_support.app_runtime.static_assets import register_static_assets
...
def create_app(*, startup_state: dict | None = None, register_health_routes: bool = True) -> FastAPI:
    ...
    if register_health_routes:
        from tests.test_support.database_test_support import _session_stats, check_database_health

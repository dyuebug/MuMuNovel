...
SOURCE_MAP_FREEZE_REASON = (
    ...
    "and response contract; this Python resume orchestration module is kept "
    "only as frozen rollback/source-map material after the remaining batch "
    "orchestration owner was split into narrower shells."
)

...
SOURCE_MAP_FREEZE_REASON = (
    "Rust owns the active batch-generation read-context, status projection, "
    "and task-view payload chain; this Python read/status owner module is "
    "kept only as frozen rollback/source-map material after the remaining "
    "legacy route wiring owner was split into narrower shells."
)

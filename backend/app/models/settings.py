...
class Settings(Base):
    ...
    provider_type = Column(String(50), default="openai", comment="Provider类型(openai/azure/newapi/custom)")
    fallback_strategy = Column(String(20), default="auto", comment="端点切换策略(auto/manual)")

...
use crate::services::{
    book_polish_generation_service::generate_book_polish_candidate,
...
impl PolishService {
    ...
    async fn polish_text(
        ...
        .await?;
        let candidate = generate_book_polish_candidate(
            original_text,
            style,
            focus_mode,
            preserve_paragraphs,
        ...
        let polished_text = candidate.content;
        ...
        Ok(json!({
            ...
            "word_count_before": candidate.word_count_before,
            "word_count_after": candidate.word_count_after,
        }))
    }

...
use crate::services::settings_service::normalize_openai_compatible_base_url;
...
use super::SingleChapterGenerationTarget;
...
pub(crate) fn build_single_chapter_research_payload_owner_contract() -> Value {
    json!({
        ...
        "rust_owner_map": [
            ...
            "compose_single_chapter_grok_query",
            "compose_single_chapter_generation_memory_query",
            "build_single_chapter_relevant_memories_payload",
            "replace_chapter_research_memories"
        ],
        "behavior_contract": {
            "compat_options_consumed": [
            ...
            "web_research_disabled_returns_context_only": true,
            "custom_query_precedence": "web_research_query overrides generated Exa/Grok query seed",
            "asset_limit": DEFAULT_MAX_ASSETS,
            "research_memory_type": RESEARCH_MEMORY_TYPE,
        },
        "active_consumers": [
        ...
        "validation_boundary": {
            "focused_test": "chapter_single_generation_prepare_service::research_payload_owner",
...
mod tests {
    ...
    use super::{
        ...
        build_memory_prompt_line, build_single_chapter_research_payload_owner_contract,
        compose_single_chapter_generation_memory_query, compose_single_chapter_grok_query,
        compose_single_chapter_research_query, normalize_research_text, ExaSearchResult,
    ...
    #[test]
    fn should_publish_single_chapter_research_payload_owner_contract() {
        ...
        assert_eq!(
            contract["behavior_contract"]["compat_options_consumed"],
            json!([
                "web_research_enabled",
                "web_research_query",
                "story_creation_brief",
        ...
        assert_eq!(
            contract["behavior_contract"]["custom_query_precedence"],
            "web_research_query overrides generated Exa/Grok query seed"
        );
        assert_eq!(contract["behavior_contract"]["asset_limit"], 2);
        assert_eq!(
            contract["active_consumers"],
            json!([
                "chapter_single_generation_prepare_service",
                "chapter_batch_generation_runtime_state_service",
                "chapter_regeneration_prepare_service"

"""Database test support for retired Python FastAPI route adapters."""
...
from tests.test_support.retired_runtime_test_support import settings
...
async def get_db(request: _FastAPIRequest):
    """FastAPI dependency that yields a database session for test adapters."""

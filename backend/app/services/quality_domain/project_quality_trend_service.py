...
from app.services.quality_domain.project_quality_trend_snapshot_store import (
    load_project_quality_trend_snapshot,
    persist_project_quality_trend_snapshot,
)
from app.services.quality_domain.story_quality_feedback_service import (
...
async def get_project_quality_trend_snapshot(
    *,
    ...
    analyzed_chapters: int,
    last_generated_at: Optional[datetime],
    build_summary_state_fn: Callable[..., Optional[Dict[str, Any]]] = build_quality_metrics_summary_state,
    advance_summary_state_fn: Callable[..., Optional[Dict[str, Any]]] = advance_quality_metrics_summary_state,
    summary_from_state_fn: Callable[..., Optional[Dict[str, Any]]] = build_quality_metrics_summary_from_state,
    load_snapshot_fn: Callable[[str, int], Optional[Dict[str, Any]]] = load_project_quality_trend_snapshot,
    persist_snapshot_fn: Callable[[str, int, Dict[str, Any]], None] = persist_project_quality_trend_snapshot,
...
async def build_project_quality_trend_response_payload(
    *,
    ...
    limit: int,
    resolve_snapshot_fn: Callable[..., Any],
) -> Dict[str, Any]:
    items: List[Dict[str, Any]] = []
    metrics_history: List[Dict[str, Any]] = []

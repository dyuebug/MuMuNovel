...
MuMuNovel 是一个基于 AI 的智能小说创作助手，旨在帮助作者通过 AI 技术提升创作效率。项目支持多种 AI 模型（OpenAI、Gemini、Claude），提供智能向导自动生成大纲、角色和世界观，支持角色关系可视化管理、章节编辑与润色、伏笔追踪、提示词工坊等功能。
...
MuMuNovel 采用前后端分离架构，后端使用 FastAPI 提供 RESTful API 和 SSE 流式接口，前端使用 React + TypeScript 构建单页应用。

...
pub(crate) fn backfill_missing_quality_snapshot_fields_from_runtime_state(
    ...
    let resolved_quality_context = resolve_generation_quality_runtime_context_from_persisted_sources(
        "batch",
...
mod tests {
    ...
    use super::{
        ...
        merge_chapter_generation_runtime_state, ChapterGenerationSnapshotWriteMode,
    };

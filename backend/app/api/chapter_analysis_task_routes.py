...
SOURCE_MAP_FREEZE_REASON = (
    "Rust owns the active chapter analysis task route group; this Python "
...
from app.services.manual_chapter_analysis_service import (
    prepare_manual_chapter_analysis,
)
...
# 保持 route 模块上的 patch surface 稳定，测试可以直接 monkeypatch 这里。
